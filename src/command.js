...
import { newNote, getAllNotes, findNotes, removeAllNotes, removeNote } from "./notes.js";
...
yargs(hideBin(process.argv))
    .command('new <note>', 'create a new note', yargs => {
        ...
        console.log("Note added!", note.content, note.id)
    })
    .option('tags', {
        alias: 't',
        type: 'string',
    ...
    .command('find <filter>', 'get matching notes', yargs => {
        ...
        const notes = findNotes(argv.filter)
        listNotes(notes)
    })
    .command('remove <id>', "remove a note by it's id", yargs => {
